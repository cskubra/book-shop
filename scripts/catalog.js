...
function appendData(data) {
  ...
  btnOurBooks.innerText = 'MORE ...';
  sp1.className = 'border';
  sp2.className = 'border';
  sp1.innerText = 'welcome to  ';
  sp2.innerText = 'book shop';
  ...
  let itemCount = 0;
  let btnToggleCartText = document.createTextNode('Basket');
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    imgAddToCart.src = '../images/shop.ico';
    btnAddToCart.appendChild(imgAddToCart);
    let add2Cartext = document.createTextNode('Add to ... ');
  ...
  bookShopAuthorP.innerText = 'Kubra Caliskan';
